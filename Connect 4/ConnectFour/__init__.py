...
__all__ = ["heuristic_suggested", "Connect_Four_State", "TreeNode",
           "A_Star_Search", "MiniMax", "MCTS",
           "Connect_Four_Terminal_APP", "Connect_Four_GUI_APP",
           "Analyse_Algorithm_Time_Space", "Display_Results", "Analyse_Game_State"]
...
from .Algorithms_Analysis import (Analyse_Algorithm_Time_Space, Display_Results, Analyse_Game_State)